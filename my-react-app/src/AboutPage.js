  ...
  return (
    <main className='backgroundBlack'>
        ...
        <section className='ChampionContainer'>
            <img src={'/static/mediaAQ11.webp'} className="ChampionImage" alt="Champion" />
            <div className='AboutTournamenttitles'>
                <div className='ChampionTournamentTitle'>Tournaments</div>
                <div className='ChampionTournamentText'>Competitive BodyBuilding IFBB <br/>
                • 1st place in NPC Illinois State Championship <br/>• 1st place Mr. Olympia South America <br/>• 1st place 44th Central American and Caribbean Championship of Bodybuilding <br/>• 3rd place 42nd South American Championship of Bodybuilding and Fitness <br/>• 2nd place 41st South American Championship of Bodybuilding and Fitness <br/>• 1st place 2015 National Championships A, B, C Venezuelan Federation of Bodybuilding.Venezuela May 2015</div>
            </div>
        </section>
        ...
        <section className='AboutImageGrid'>
            <div className='buttomPlacement'>
                <div className='CostumeButton' onClick={() => window.open("mailto:alfitcoaching@gmail.com?subject=Contact&body=Hello, I would like to connect with you!")}>CONTACT ME!</div>
            </div>
